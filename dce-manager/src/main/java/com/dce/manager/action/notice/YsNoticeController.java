...
public class YsNoticeController extends BaseAction{
    ...
    public void listYsNotice(NewPagination<NoticeDo> pagination,
    							  ModelMap model,
    ...
    public void export(HttpServletResponse response) throws IOException {
        try {
            ...
            NoticeDoExample example  = new NoticeDoExample();
            String companyName = getString("searchPolicyName");
            ...
            HSSFWorkbook wb = ExeclTools.execlExport(excelheaderList, excelData, excelHead, ysnoticeLst);
