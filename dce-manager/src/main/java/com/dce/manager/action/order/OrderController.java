...
public class OrderController extends BaseAction {
	...
	public void list(Pagination<Map<String, Object>> pagination,
		...
		try {
			...
			PageDo<Map<String, Object>> orderList = orderService.selectOrderByPage(page, params);
			params.put("orderType", 2);
			
			Long qty = orderService.selectGuadanAmount(params);
			Map<String,Object> sum = new HashMap<String,Object>();
			sum.put("user_name", "挂单总计:" + (qty == null?0:qty));
