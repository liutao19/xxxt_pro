...
public class RegionalawardsController extends BaseAction{
    ...
    public void listRegionalawards(NewPagination<Regionalawards> pagination,
    							  ModelMap model,
    ...
    @ResponseBody
    public void saveRegionalawards(Regionalawards regionalawardsDo, 
    							  HttpServletRequest request, 
    							  HttpServletResponse response) {
        logger.info("----saveRegionalawards------");
        try{
    ...
    public void export(HttpServletResponse response) throws IOException {
        try {
            ...
            RegionalawardsExample example  = new RegionalawardsExample();
            String companyName = getString("searchPolicyName");
            ...
            List<Regionalawards> regionalawardsLst = regionalawardsService.selectRegionalawards(example);
            ...
            HSSFWorkbook wb = ExeclTools.execlExport(excelheaderList, excelData, excelHead, regionalawardsLst);
