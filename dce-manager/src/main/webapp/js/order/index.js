...
/*##########################grid init begin###################################################*/
	...
	var columns_tt = [
      			[
	 				...
	 				{field:"orderId",title:"ID",width:30,align:"center"},
	 				{field:"user_name",title:"用户名",width:80,align:"center",
	 				...
	 				{field:"user_level",title:"客户级别",width:30,align:"center",
						formatter:function(value,row,index){
							if(value == undefined){
								return "";
							}
	 				...
	 				{field:"qty",title:"目标数量",width:30,align:"center"},
	 				{field:"salqty",title:"已达数量",width:30,align:"center"},
	 				{field:"createTime",title:"充值时间",width:80,align:"center",
	 					formatter:function(value,row,index){
...
//	 							return '<a href="javascript:void(0);"  onclick="checkOrder('+row.orderId+',\''+2+'\');">通过</a> |' +
//	 							'<a href="javascript:void(0);"  onclick="checkOrder('+row.orderId+',\''+3+'\');">拒绝</a>';
//	 						}
//		 				}
//	 				}
	 			]
