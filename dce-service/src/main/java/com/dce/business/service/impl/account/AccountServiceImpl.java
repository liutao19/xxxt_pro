...
public class AccountServiceImpl implements IAccountService {
    ...
    public int updateUserAmountById(UserAccountDo userAccountDo, IncomeType type) {
        ...
        updateUserAmountDetail(amount, type, userId, accountType, userAccountDo.getRemark(),userAccountDo.getSeqId(), userAccountDo.getRelevantUser());
    ...
    private boolean updateUserAmountDetail(BigDecimal amount, 
    									   ...
    									   String accountType, 
    									   String remark,
    									   String seqId, String relevantUserid) {
		//读取账户余额
	...
	@Override
	@Transactional(rollbackFor = Exception.class, propagation = Propagation.REQUIRED)
	public void convertBetweenAccount(Integer sourceUserId, Integer targetUserId, BigDecimal sourceAmount, BigDecimal targetAmount,
			String fromAccount, String toAccount, IncomeType sourceMsg, IncomeType targetMsg) {
		...
		userAccountDetailDao.addAccountTranLog(seqId, sourceUserId, targetUserId, sourceAmount, fromAccount, toAccount, sourceMsg);
...
//		
//		//查询美元点比DCE币的比例 N:1
//        LoanDictDtlDo MYDBXCC = loanDictService.getLoanDictDtl(DictCode.Point2RMB.getCode());
...
//        targetAmt = targetAmt.divide(new BigDecimal(1), 6, RoundingMode.HALF_UP);
	...
	@Override
	public PageDo<UserAccountDetailDo> selectUserAccountDetailByPage(
			PageDo<UserAccountDetailDo> page, Map<String, Object> params) {
